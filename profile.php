...
<body>
  ...
  <main style="text-align:center;margin-top:150px;margin-bottom:130px">
    <?php
            ...
            $sql="SELECT * FROM `profile` WHERE `city`='$city' and `profile`='$profile'";
                ...
                while($sr=mysqli_fetch_assoc($sp))
                    {
                     ?> 
                        ...
                        <tr>
                            <td><?php echo "Name: ".$sr['name'] ?></td> 
                            <td> <?php echo "City: " .$sr['city']?></td>
                            <td><?php echo "Mobile No.: ".$sr['Mobile No.'];?></td>
                            <td><a href="order.php?city=<?php echo $sr['city']; ?>&id=<?php echo $sr['No'];?>"><button onclick="myorder()">Hire me</button></a></td>
                        </tr>
