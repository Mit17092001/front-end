...
$publishable_key 	= 'pk_test_51Mq8OZSIiEFKEPzTx5NCTD758P2eMjqEcYtXefdt34Pj2WL65GTlG2062leXxoouraTjf69SowcWjgiXvqhYXWOk00BxfySViI';
$secret_key			= "sk_test_51Mq8OZSIiEFKEPzTIq1BZu2jqgWMzIBKfJpLdTVnRDXoPL6wH4gp6Ju3okYqB5QLSA6Hkwn8wlxP5Xt9y6FbSKaE00JAsXarXn";
                              ...
                              <form action="" method="post" name="cardpayment" id="payment-form">
                                ...
                                <div class="button-style">
                                    <button class="button login submit">
                                       Paynow (₹199.00) <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                    </button>
                                </div>
